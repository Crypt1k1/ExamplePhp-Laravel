        ...
        <div class="card-body grid grid-cols-1 gap-6 lg:grid-cols-1">
            <div class="p-4">
                ...
                focus:outline-none focus:shadow-outline-purple form-input"
                               name="name" value="{{ $review->text }}" type="text" disabled >

                        <p class="py-2 text-lg text-gray-700">description: {{ $review->car_id }}</p>
                        <p class="py-2 text-lg text-gray-700">brand: {{ $review->user_id }}</p>
